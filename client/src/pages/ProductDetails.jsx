...
const ProductDetails = () => {
    ...
    <div onClick={() => setThumbnail(product.image)} className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
